...
Есть входящие наборы данных data1.txt (линейное уравнение), data2.txt (теорема пифагора). Например набор data1.txt (линейное уравнение) выглядит вот так:
...
- Теорема пифагора решается за 8 100 секунд (8 символов) bl|(;v|x0;e|**2;o|+;v|x1;e|**2;br|);e|**0.5
